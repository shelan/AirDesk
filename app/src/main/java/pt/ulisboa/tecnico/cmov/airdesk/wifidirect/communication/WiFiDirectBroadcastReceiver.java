...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, Channel channel,
                                       MainActivity.CommunicationManager communicationManager) {
        super();
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        manager.requestConnectionInfo(channel, communicationManager);
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (state == WifiP2pManager.WIFI_P2P_STATE_ENABLED) {
                ...
                Toast.makeText(context, "WIFI_P2P_STATE_ENABLED",
                        Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(context, "WIFI_P2P_STATE_DISABLED",
                        Toast.LENGTH_SHORT).show();
            ...
            //AirDeskService.getInstance().setMyDevice(device);
        }
    }
}
