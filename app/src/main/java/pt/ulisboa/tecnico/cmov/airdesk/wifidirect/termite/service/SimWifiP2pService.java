package pt.ulisboa.tecnico.cmov.airdesk.wifidirect.termite.service;
...
import pt.ulisboa.tecnico.cmov.airdesk.wifidirect.termite.util.NetworkUpdateParser;
import pt.ulisboa.tecnico.cmov.airdesk.wifidirect.termite.util.Protocol;
...
public class SimWifiP2pService extends AsyncService {
	...
	@Override
	public AsyncService.AsyncServiceInfo createHandler() {
                ...
                case SimWifiP2pService.NETWORK_UPDATE:
                	...
                	if (parser.mOutSuccess) {
	                    ...
	                    if (devsChg) {
                            ...
                            System.out.println("---------------------------------");
                            System.out.println("---------------------------------");
                            System.out.println("--------WIFI_P2P_DEVICE_INFO_CHANGED_ACTION bcast-----------");
                            System.out.println("---------------------------------");
                            sendBroadcast(intent);
		                }
	                    if (neibChg) {
